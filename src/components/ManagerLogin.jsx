      ...
      <div className="login-container">
        ...
        <div className="login-form-container">
          ...
          <div className="login-form-content">
            <h1 className="login-title">تسجيل دخول المدير</h1>
            <p className="login-subtitle">مرحباً بك في بوابة المدراء، يرجى إدخال بيانات الدخول</p>
            ...
            <form className="login-form" onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                ...
                <div className="password-input-wrapper">
                  ...
                  />
                  <div className="password-requirements">Min. 10 characters with special char</div>
